...
var = [12, 2]
rho = -0.5
cov = [[var[0], rho * np.sqrt(var[0]*var[1])], [np.sqrt(var[0]*var[1]), var[1]]] #????
...
corr_matrix = [[var1/(np.sqrt(var1) * np.sqrt(var1)), cov/(np.sqrt(var1) * np.sqrt(var2))], [cov/(np.sqrt(var2) * np.sqrt(var1)), var2/(np.sqrt(var2) * np.sqrt(var2))]]
...
print('cov_matrix_pack',cov_matrix_pack)
print('corr_matrix_pack',corr_matrix_pack)
