...
plt.legend()
plt.savefig('plots/Aufgabe2/a2_df.eps', format='eps')
plt.show()
...
plt.legend()
plt.ylim([-0.1, 1.1])
plt.savefig('plots/Aufgabe2/a2_posterior.eps', format='eps')
plt.show()
...
plt.ylabel(r'$p(x)$')
plt.legend()
plt.savefig('plots/Aufgabe2/a2_evidence.eps', format='eps')
plt.show()